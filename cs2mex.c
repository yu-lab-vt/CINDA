...

{
  ...
  FOR_ALL_NODES_i
      FOR_ALL_ARCS_a_FROM_i if (OPEN(a) && (REDUCED_COST(i, a->head, a) < 0))
  {
    return (0);
  }
...

{
  ...
  FOR_ALL_NODES_i
      FOR_ALL_ARCS_a_FROM_i if (OPEN(a) && (REDUCED_COST(i, a->head, a) < -epsilon))
  {
    return (0);
  }
...

{
  ...
  n_update = n_scan = n_prefine = n_prscan = n_prscan1 = n_bad_pricein = n_bad_relabel = 0;
